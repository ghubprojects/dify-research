...
- Chọn giữa built-in views, OpenTelemetry/Sentry và external LLM tracing integration mà không gửi dữ liệu nhạy cảm ngoài ý muốn.
...
- External Langfuse/Opik/Weave credential nằm trong secret manager; endpoint, region, tenancy, subprocessors và retention phải qua Security/Privacy review.
