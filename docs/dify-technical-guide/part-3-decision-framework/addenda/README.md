...
Mỗi file mới dùng cấu trúc dưới đây. Metadata phải được điền trước `POC-G0` của addendum; mục chưa có evidence ghi rõ owner và `RUNTIME-PENDING`, không để trống.
